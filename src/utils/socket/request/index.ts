...
const mock = () => {
  ...
  if(userAgent.includes('Chrome')) {
    return 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYwOTM0ZGE1NjFjM2Q0MGJhNjhhNjZhOSIsIm1vYmlsZSI6MTM1MjcxMDY4NzksIm1pZGRlbCI6Ik1JRERFTCIsImZyaWVuZF9pZCI6IjYwZTJkMzUwMmM5OGU0MmQyYmU2MjMxMCIsImlhdCI6MTYyODIxMzM2MSwiZXhwIjoxNjI4Mjk5NzYxfQ.eDdqWkLvrcJMp7HRJgU1RfeesOYrupsbm-wU-2fq1BM'
  }
