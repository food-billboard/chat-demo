...
const mock = () => {
  ...
  if(userAgent.includes('Chrome')) {
    return 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYwOTM0ZGE1NjFjM2Q0MGJhNjhhNjZhOSIsIm1vYmlsZSI6MTM1MjcxMDY4NzksIm1pZGRlbCI6Ik1JRERFTCIsImZyaWVuZF9pZCI6IjYwZTJkMzUwMmM5OGU0MmQyYmU2MjMxMCIsImlhdCI6MTYyODQ3OTQ2MiwiZXhwIjoxNjI4NTY1ODYyfQ.0AlJn9FI6JIgdwz3VsbfkKMjAYlQ9sdAkpi3FKKAUNw'
  }
  return 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYwOTg5MTI2NzJjMTEyMDlkZDVjNjdlYSIsIm1vYmlsZSI6MTgzNjgwMDMxOTAsIm1pZGRlbCI6Ik1JRERFTCIsImZyaWVuZF9pZCI6IjYwZTJkMzUwMmM5OGU0MmQyYmU2MjMxMSIsImlhdCI6MTYyODIxMjM5NywiZXhwIjoxNjI4Mjk4Nzk3fQ.z7WzT1Or1YXT6BRORv-8sqvcz2hAchLP4WhCcXnhAjA'
}
