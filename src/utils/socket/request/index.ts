...
const mock = () => {
  ...
  if(userAgent.includes('Chrome')) {
    return 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYwOTg5MTI2NzJjMTEyMDlkZDVjNjdlYSIsIm1vYmlsZSI6MTgzNjgwMDMxOTAsIm1pZGRlbCI6Ik1JRERFTCIsImZyaWVuZF9pZCI6IjYwZTJkMzUwMmM5OGU0MmQyYmU2MjMxMSIsImlhdCI6MTYyODU3OTg1NywiZXhwIjoxNjI4NjY2MjU3fQ.Q2jKM9esaFYZMYcpxDBX3GTVZ_8uIQVdYHQn5dd59iY'
  }
