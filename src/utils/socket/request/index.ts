...
const mock = () => {
  ...
  if(userAgent.includes('Chrome')) {
    return 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYwN2MxNzZmMGY4NzJjN2EzZDU5NWNjMiIsIm1vYmlsZSI6MTgzNjgwMDMxOTAsIm1pZGRlbCI6Ik1JRERFTCIsImZyaWVuZF9pZCI6IjYwZTE0MWQ2YWVlYTEyMGUxYWNjYzE1ZiIsImlhdCI6MTYzNDI4NTE0OCwiZXhwIjoxNjM0MzcxNTQ4fQ.5wczpONRnMhxmwzf-EI3YJpYTmhe-2La-KVMVWXor4Y'
  }
  return 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYwYzQ5NmI2MmUyMDZkMTgwMzg1ODA0NyIsIm1vYmlsZSI6MTM1MDE4MjM0NzksIm1pZGRlbCI6Ik1JRERFTCIsImZyaWVuZF9pZCI6IjYwZTE0MWQ2YWVlYTEyMGUxYWNjYzE2MCIsImlhdCI6MTYzNDI4NjM3NywiZXhwIjoxNjM0MzcyNzc3fQ.oBt7npEi6xDQUPArOKhS5BHcoOZWI-ektrkCtWi3iUc'
}
